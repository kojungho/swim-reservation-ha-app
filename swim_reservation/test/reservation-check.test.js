...
test("예약자명은 EUC-KR로 인코딩하고 휴대폰 번호는 세 부분으로 나눈다", () => {
  assert.equal(
    ...
    "https://newpension.logosweb.or.kr/reservation/order_ok7.php?id=swim&name=%B0%ED%C1%DF%C8%A3&tel1=010&tel2=7430&tel3=2277"
  );
});
...
test("취소 주소에는 예약 식별값과 동일한 예약자 정보가 포함된다", () => {
  assert.equal(
    ...
    "https://newpension.logosweb.or.kr/reservation/order_del3.php?no=493304&id=swim&name=%B0%ED%C1%DF%C8%A3&tel1=010&tel2=7430&tel3=2277"
  );
